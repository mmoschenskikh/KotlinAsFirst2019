...
class Tests {
    ...
    @Tag("Normal")
    fun convert() {
        assertEquals(listOf(0), convert(0, 99))
    ...
    @Tag("Hard")
    fun convertToString() {
        assertEquals("0", convertToString(0, 234))
    ...
    fun decimal() {
        ...
        assertEquals(Int.MAX_VALUE, decimal(listOf(10, 0, 2, 2, 2, 0, 2, 8, 1), 11))
    }
    ...
    fun russian() {
        ...
        assertEquals("сто тысяч пятьсот", russian(100500))
        assertEquals("один", russian(1))
        assertEquals("десять тысяч", russian(10000))
        assertEquals("одна тысяча", russian(1000))
        assertEquals("сто одна тысяча триста восемнадцать", russian(101318))
