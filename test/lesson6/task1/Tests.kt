...
class Tests {
    ...
    fun bestHighJump() {
        ...
        assertEquals(-1, bestHighJump("999 --- 322 %-% 585 -- 586 - 228 %"))
        assertEquals(585, bestHighJump("999 --- 322 %-% 585 -+----+++--+- 586 - 228 %"))
    }
    ...
    fun mostExpensive() {
        ...
        assertEquals("", mostExpensive("Хлеб 39.9; Молоко 62; Курица 184; Конфеты -90909"))
        assertEquals("Вино", mostExpensive("Вино 255.0"))
        assertEquals(",", mostExpensive(", 0.02; , 0; a 0.01"))
    }
